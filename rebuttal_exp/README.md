...
| **E1** CKA/SVCCA/Procrustes(+E8 iso_dev) | **C**(診斷);G3T9-W3, pCi8-W3;E8→pCi8-W6 | ~3–5 h | 待跑 | 主文 2 families;⚠️ Gemini「有 cached activations 免 forward」是錯的,需重抽特徵;log 計時餵 E12 |
