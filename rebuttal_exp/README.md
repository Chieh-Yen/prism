...
| **E15** reference draw ablation(**paired**) | **B**;8VrD-Q3 | ~5.3 h(實測 5090 ~79 min/cell;Part 0 為 0) | Part 0 ✅(4 draws **DISJOINT**;wikitext n=32 實際只交付 **19 條**、2.1× tokens、無 prompt 邊界 → E3-C domain 對比為 unpaired);**Part A 待跑** | λ=**1.0**(論文 Table 2 那格),offset 0 = 論文樹 0.6813 免費;含 replicate 當 floor + 重現 canary。**附帶勘誤**:E3.md §8.2 的 −51% 是拿錯 no-reg anchor(1.4830 為 pre-grad-fix 舊值,論文輪是 **0.8434**)→ E3.md §8.4 |
