...
def main():
    ...
    plot_curves(table, FIG_DIR / "forgetting_curves.pdf")
    plot_tradeoff(rows, FIG_DIR / "forgetting_tradeoff.pdf")
    print("\nPer-target figures:")
    plot_per_target(table, FIG_DIR / "per_target_figs")
    print("\nGrouped figures:")
    plot_grouped(table, FIG_DIR)
    recommend(rows)
