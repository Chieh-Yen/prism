...
\end{equation}
This is the $W = W_N$ generalization of Proposition~\ref{prop:exact_decomposition}; setting $W = I$ in the same expansion (no SVD needed) recovers the main-text identity with $\Omega$ in place of $\Omega_N$. \qed
